...
Use AskUser only for tiger-level risks requiring implementation hold: "BLOCKED: {risk summary}. Options: add mitigation, accept with justification, need research."
